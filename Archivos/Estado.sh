#!/bin/bash
DIR_TO_CHECK='/home/jesus/Documentos/Pruebas/Ficheros' #Directorio que queremos inspeccionar

OLD_STAT_FILE='/home/jesus/Documentos/Pruebas/Viejo.txt' #Fichero "hash" con el directorio antiguo
