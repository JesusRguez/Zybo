...
%Para la instalación del sistema operativo podemos ver el apéndice \hyperlink{InstalacionLinux}{Instalación de Linux en SD para tarjetas Zybo.}  Me hadicho Mirian que lo quite y borre el apéndice correspondiente.
