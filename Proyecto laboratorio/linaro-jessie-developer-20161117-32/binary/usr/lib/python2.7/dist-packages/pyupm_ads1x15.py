...
class ADS1X15(_object):
    ...
    def getLastSample(self, *args):
        """
        getLastSample(ADS1X15 self, int reg=(0x00)) -> float

        Parameters:
            reg: int

        getLastSample(ADS1X15 self) -> float
    ...
    def getSample(self, *args):
        """
        getSample(ADS1X15 self, upm::ADS1X15::ADSMUXMODE mode=DIFF_0_1) -> float

        Parameters:
            mode: enum upm::ADS1X15::ADSMUXMODE

        getSample(ADS1X15 self) -> float
    ...
    def getGain(self):
        """
        getGain(ADS1X15 self) -> upm::ADS1X15::ADSGAIN
    ...
    def setGain(self, *args):
        """
        setGain(ADS1X15 self, upm::ADS1X15::ADSGAIN gain=GAIN_TWO)

        Parameters:
            gain: enum upm::ADS1X15::ADSGAIN

        setGain(ADS1X15 self)
    ...
    def getSPS(self):
        """
        getSPS(ADS1X15 self) -> upm::ADS1X15::ADSSAMPLERATE
    ...
    def setSPS(self, *args):
        """
        setSPS(ADS1X15 self, upm::ADS1X15::ADSSAMPLERATE rate)

        Parameters:
            rate: enum upm::ADS1X15::ADSSAMPLERATE
        ...
        """
        return _pyupm_ads1x15.ADS1X15_setSPS(self, *args)

    def getCompMode(self):
        """
        getCompMode(ADS1X15 self) -> bool
    ...
    def setCompMode(self, mode=False):
        """
        setCompMode(ADS1X15 self, bool mode=False)

        Parameters:
            mode: bool

        setCompMode(ADS1X15 self)
    ...
    def setCompPol(self, mode=False):
        """
        setCompPol(ADS1X15 self, bool mode=False)

        Parameters:
            mode: bool

        setCompPol(ADS1X15 self)
    ...
    def getCompLatch(self):
        """
        getCompLatch(ADS1X15 self) -> bool
    ...
    def setCompLatch(self, mode=False):
        """
        setCompLatch(ADS1X15 self, bool mode=False)

        Parameters:
            mode: bool

        setCompLatch(ADS1X15 self)
    ...
    def getCompQue(self):
        """
        getCompQue(ADS1X15 self) -> upm::ADS1X15::ADSCOMP
    ...
    def setCompQue(self, *args):
        """
        setCompQue(ADS1X15 self, upm::ADS1X15::ADSCOMP mode=CQUE_NONE)

        Parameters:
            mode: enum upm::ADS1X15::ADSCOMP

        setCompQue(ADS1X15 self)
    ...
    def getContinuous(self):
        """
        getContinuous(ADS1X15 self) -> bool
    ...
    def setContinuous(self, mode=False):
        """
        setContinuous(ADS1X15 self, bool mode=False)

        Parameters:
            mode: bool

        setContinuous(ADS1X15 self)
    ...
    def getThresh(self, *args):
        """
        getThresh(ADS1X15 self, upm::ADS1X15::ADSTHRESH reg=THRESH_LOW) -> float

        Parameters:
            reg: enum upm::ADS1X15::ADSTHRESH

        getThresh(ADS1X15 self) -> float
        ...
        float
        getThresh(ADSTHRESH reg=THRESH_LOW)
    ...
    def setThresh(self, *args):
        """
        setThresh(ADS1X15 self, upm::ADS1X15::ADSTHRESH reg=THRESH_DEFAULT, float value=0.0)

        Parameters:
            reg: enum upm::ADS1X15::ADSTHRESH
            value: float

        setThresh(ADS1X15 self, upm::ADS1X15::ADSTHRESH reg=THRESH_DEFAULT)

        Parameters:
            reg: enum upm::ADS1X15::ADSTHRESH

        setThresh(ADS1X15 self)
...
class ADS1015(ADS1X15):
    ...
    Link: webhttp://www.ti.com/lit/ds/symlink/ads1015.pdf  The ADS1013,
    ...
    as ±256mV, allowing both large and small signals to be measured with
    high resolution. The ADS1015 also features an input multiplexer (MUX)
    that provides two differential or four single-ended inputs. The
    ...
    ADS1013/4/5 are specified from –40°C to +125°C.

    Tested with Adafriut ADS1015
    board:https://www.adafruit.com/products/1083

    C++ includes: ads1015.h 
    """
    __swig_setmethods__ = {}
    for _s in [ADS1X15]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ADS1015, name, value)
    __swig_getmethods__ = {}
    for _s in [ADS1X15]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def __init__(self, *args): 
        """
        __init__(upm::ADS1015 self, int bus, uint8_t address=0x48, float vref=2.048) -> ADS1015
        ...
        __init__(upm::ADS1015 self, int bus, uint8_t address=0x48) -> ADS1015

        Parameters:
            bus: int
            address: uint8_t

        __init__(upm::ADS1015 self, int bus) -> ADS1015
        ...
        2.048V 
        """
        this = _pyupm_ads1x15.new_ADS1015(*args)
    ...
    def setSPS(self, *args):
        """
        setSPS(ADS1015 self, upm::ADS1015::ADSSAMPLERATE rate=SPS_1600)

        Parameters:
            rate: enum upm::ADS1015::ADSSAMPLERATE
    ...
    def getNumInputs(self):
        """
        getNumInputs(ADS1015 self) -> unsigned int
    ...
    def getRawValue(self, *args):
        """
        getRawValue(ADS1015 self, unsigned int input) -> uint16_t
        ...
        """
        return _pyupm_ads1x15.ADS1015_getRawValue(self, *args)

    def getVoltage(self, *args):
        """
        getVoltage(ADS1015 self, unsigned int input) -> float
        ...
        current voltage 
        """
        return _pyupm_ads1x15.ADS1015_getVoltage(self, *args)

    def getResolutionInBits(self):
        """
        getResolutionInBits(ADS1015 self) -> unsigned int
    ...
    def getModuleName(self):
        """
        getModuleName(ADS1015 self) -> char const *
...
class ADS1115(ADS1X15):
    ...
    def __init__(self, *args): 
        """
        __init__(upm::ADS1115 self, int bus, uint8_t address=0x48) -> ADS1115

        Parameters:
            bus: int
            address: uint8_t

        __init__(upm::ADS1115 self, int bus) -> ADS1115
        ...
        """
        this = _pyupm_ads1x15.new_ADS1115(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def setSPS(self, *args):
        """
        setSPS(ADS1115 self, upm::ADS1115::ADSDATARATE rate=SPS_128)

        Parameters:
            rate: enum upm::ADS1115::ADSDATARATE
