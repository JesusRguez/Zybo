...
class Time3231(_object):
    ...
    if _newclass:second = _swig_property(_pyupm_maxds3231m.Time3231_second_get, _pyupm_maxds3231m.Time3231_second_set)
    ...
    if _newclass:minute = _swig_property(_pyupm_maxds3231m.Time3231_minute_get, _pyupm_maxds3231m.Time3231_minute_set)
    __swig_setmethods__["hour"] = _pyupm_maxds3231m.Time3231_hour_set
    __swig_getmethods__["hour"] = _pyupm_maxds3231m.Time3231_hour_get
    if _newclass:hour = _swig_property(_pyupm_maxds3231m.Time3231_hour_get, _pyupm_maxds3231m.Time3231_hour_set)
    __swig_setmethods__["day"] = _pyupm_maxds3231m.Time3231_day_set
    __swig_getmethods__["day"] = _pyupm_maxds3231m.Time3231_day_get
    if _newclass:day = _swig_property(_pyupm_maxds3231m.Time3231_day_get, _pyupm_maxds3231m.Time3231_day_set)
    ...
    if _newclass:month = _swig_property(_pyupm_maxds3231m.Time3231_month_get, _pyupm_maxds3231m.Time3231_month_set)
    __swig_setmethods__["year"] = _pyupm_maxds3231m.Time3231_year_set
    __swig_getmethods__["year"] = _pyupm_maxds3231m.Time3231_year_get
    if _newclass:year = _swig_property(_pyupm_maxds3231m.Time3231_year_get, _pyupm_maxds3231m.Time3231_year_set)
    ...
    if _newclass:weekDay = _swig_property(_pyupm_maxds3231m.Time3231_weekDay_get, _pyupm_maxds3231m.Time3231_weekDay_set)
    def __init__(self): 
...
class MAXDS3231M(_object):
    ...
    Name: MAXDS3231M Real-Time Clock

    Category: light

    Manufacturer: maxim

    Connection: i2c  This module defines the API for MAXDS3231M

    C++ includes: maxds3231m.h 
    """
    __swig_setmethods__ = {}
    ...
    def setDate(self, *args):
        ...
        time:  Time structure 
        """
        return _pyupm_maxds3231m.MAXDS3231M_setDate(self, *args)
    ...
    def getDate(self, *args):
        ...
        time:  Time structure 
        """
        return _pyupm_maxds3231m.MAXDS3231M_getDate(self, *args)
